...
export interface KompleMintReadOnlyInterface {
...
export class KompleMintQueryClient implements KompleMintReadOnlyInterface {
...
export interface KompleMintInterface extends KompleMintReadOnlyInterface {
  contractAddress: string;
  sender: string;
  createCollection: (
    {
...
export class KompleMintClient
  extends KompleMintQueryClient
  implements KompleMintInterface
{
  ...
  constructor(
    ...
    this.updatePublicCollectionCreation =
      this.updatePublicCollectionCreation.bind(this);
