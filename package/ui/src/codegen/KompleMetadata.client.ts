...
export interface KompleMetadataReadOnlyInterface {
...
export class KompleMetadataQueryClient
  implements KompleMetadataReadOnlyInterface
{
...
export interface KompleMetadataInterface
  extends KompleMetadataReadOnlyInterface {
  contractAddress: string;
  sender: string;
  addMetadata: (
    {
...
export class KompleMetadataClient
  extends KompleMetadataQueryClient
  implements KompleMetadataInterface
{
